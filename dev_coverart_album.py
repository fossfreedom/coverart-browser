...
class AlbumSorters(object):
    ...
    keys = {'name': compare_albums_by_name,
            'album_artist': compare_albums_by_album_artist,
            'year': compare_albums_by_year,
            'rating': compare_albums_by_year}
...
class AlbumManager(GObject.Object):
    ...
    def __init__(self, plugin, cover_model, policy=ShowAllPolicy()):
        ...
        self._covers_man = CoverManager(plugin)
        self._genres_man = GenresManager()
